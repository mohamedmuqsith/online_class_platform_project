    ...
    return (
        <footer style={{ background: '#c49696', color: '#fff', padding: '60px 0 30px', marginTop: '50px' }}>
            <div className="container" style={{ textAlign: 'center' }}>
                ...
                <h3 style={{ fontFamily: 'serif', fontSize: '1.8rem', marginBottom: '30px' }}>
                ...
                <div style={{
                    ...
                    <input type="email" placeholder="Your Email" style={{
                        ...
                        padding: '15px 20px', color: '#fff', placeholderColor: '#eee'
                    }} />
                    <button style={{
                ...
                <p style={{ maxWidth: '600px', margin: '0 auto 30px', fontSize: '0.9rem', opacity: 0.9 }}>
